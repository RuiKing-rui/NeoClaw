...
from neoclaw.core.context import AgentState
...
class TestAgent(unittest.TestCase):
    ...
    @patch('neoclaw.core.provider.get_provider')
    @patch('neoclaw.core.skill_loader.load_dynamic_skills')
    @patch('neoclaw.core.tools.builtins.BUILTIN_TOOLS', [])
